...
def fetch_ref_tab_name(mode, eval_horizon, train_future_frame):
	if mode == "sgdet":
		setting_name = f"sgdet_{eval_horizon}_{train_future_frame}"
	elif mode == "sgcls":
		setting_name = f"sgcls_{eval_horizon}_{train_future_frame}"
	elif mode == "predcls":
		setting_name = f"predcls_{eval_horizon}_{train_future_frame}"
	return setting_name
